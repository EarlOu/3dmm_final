...
)
{
	...
	cls = new CLStruct;
	if (
		accel.gaussian == Accel_OCL ||
		accel.dog == Accel_OCL ||
		accel.gradient == Accel_OCL ||
		accel.angle == Accel_OCL ||
		accel.descriptor == Accel_OCL
	) {
		cl_int cle;
